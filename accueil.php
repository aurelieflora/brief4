...
nav ul li{
    ...
    <div class="logo" style="margin-left: -60px;"><img src="image/LOGO WELIKE.png" alt="logo" style="width:300px; height:180px">
            ...
            <p style="font-size:15px; font-family:Arial; margin-top:5px; margin-left:10px;">Connexion
...
<a href="profil.php?page=7" class="I" style="margin-left: 15px;">PROFIL</a>
<form method="post" action="deconnexion_user.php">
    <button type="submit" name="logout" class="btn-danger"style="margin-top: -20px; margin-left: 600px; position: absolute; display:flex;">Déconnexion</button>
</form>
