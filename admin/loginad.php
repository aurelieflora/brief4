                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="upload_login.php" enctype="multipart/form-data">
                                        ...
                                        <label for="password">Entrez votre mot de passe:</label><br>
                                            ...
                                            <input type="password" class="form-control form-control-user" id="exampleInputPassword" name="mot_de_passe" >
                                        </div>
                                        <div class="form-group">
